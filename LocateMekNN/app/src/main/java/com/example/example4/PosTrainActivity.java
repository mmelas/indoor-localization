...
public class PosTrainActivity extends Activity implements OnClickListener{
     ...
     * The buttons.
     */
    private Button buttonPosTrain, buttonBalcony, buttonToilet, buttonLR,
     ...
     * Delay between scans
     */
    private int delay = 200; //Original : 200
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button tempList[] = new Button[]{buttonPosTrain, buttonBalcony, buttonToilet,
    ...
    private Runnable run = new Runnable() {
        ...
        public void run() {
            ...
            for (ScanResult scanResult : scanResults) {
                ...
                textPosTrain.setText(textPosTrain.getText() + "\n\tBSSID = "
                        + currentBSSID + "    RSSI = "
